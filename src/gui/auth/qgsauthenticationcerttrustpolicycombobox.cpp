/***************************************************************************
    qgsauthenticationcerttrustpolicycombobox.cpp
    ---------------------
    begin                : May 02, 2015
...
#include "qgsauthenticationcerttrustpolicycombobox.h"
...
void QgsAuthCertTrustPolicyComboBox::highlightCurrentIndex( int indx )
{
  ...
  switch( policy )
  {
    case QgsAuthCertUtils::Trusted:
      ...
      ss = QgsAuthCertUtils::greenTextStyleSheet( "QComboBox:open" ) + "\nQComboBox:!open{}";
      break;
    case QgsAuthCertUtils::Untrusted:
      // ss = QgsAuthCertUtils::redTextStyleSheet( "QLineEdit" );
      ss = QgsAuthCertUtils::redTextStyleSheet( "QComboBox:open" ) + "\nQComboBox:!open{}";
      break;
